...
import com.lights.hayden.lights_app.support.Constants;
...
public class Lights extends AppCompatActivity implements AddLightConfigDialog.AddLightConfigListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.addConfiguration){
            AddLightConfigDialog dialog = new AddLightConfigDialog();
            Log.i(Constants.LOG_TAG, "I am at addAdjacency record adding");
    ...
    @Override
    public void onFinishedEditDialog(ArrayList<Integer> colorID, int patternID) {
        Log.i(Constants.LOG_TAG, "In main about to add config.");
        ConfigDaemon.getInstance().addLightConfig(colorID, patternID);
